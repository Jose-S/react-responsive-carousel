...
var Carousel = function (_Component) {
    ...
    _createClass(Carousel, [{
        ...
        value: function renderControls() {
            var _this4 = this;
            var _increment = 100 / this.props.children.length;

            console.log("SIZE", _increment);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("div", { className: "control-dots-inner" },
                    _react2.default.createElement("div", { className: "control-dots-box", style: { left: `${_this4.state.selectedItem * _increment}%`, width: `${_increment}%`}}))
                );
        }
    }, {
        key: 'renderStatus',
